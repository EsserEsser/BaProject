...
//****************************************************************************************** General histograms
    ...
    TH1D *MultiHist = new TH1D("MultiHist", "Charged Particle Multiplicity", 57, 0, 57);
    TH1D *thrustxHist = new TH1D("thrustxHist", "Thrust x", 57, 0, 57);
    TH1D *thrustyHist = new TH1D("thrustyHist", "Thrust y", 57, 0, 57);
    TH1D *thrustzHist = new TH1D("thrustzHist", "Thrust z", 57, 0, 57);
...
//*************************************************************************************************** Data Loop
    for (Long64_t i = 0; i < numberOfEntries; i ++){
        ...
        if (t.cmenergy > 90.8 &&  t.cmenergy < 91.6){
            ...
            // if(Particle1Count >0){
            // Particle1ThrustProfile->Fill(chargeMulti,pThrustParticle1/Particle1Count);
            // }
            ChargedMultiHist->Fill(chargeMulti);
            MultiHist->Fill(multi);
...
//****************************************************************************************** Saving Plots
    ...
    // 5. Save histograms
        ...
        Particle1ThrustProfile->SetTitle("Thrust Profile particle1");  // Title inside the plot
        Particle1ThrustProfile->SetXTitle("Charge Multiplicity ");
        Particle1ThrustProfile->SetYTitle(" <p_{T}> (GeV)");
        Particle1ThrustProfile->Write();  // "E" ensures error bars are displayed
        Particle1Hist->Write();
        ...
        Particle2ThrustProfile->SetTitle("Thrust Profile Particle2");  // Title inside the plot
        Particle2ThrustProfile->SetXTitle("Charge Multiplicity");
        Particle2ThrustProfile->SetYTitle(" <p_{T}> (GeV)");
        Particle2ThrustProfile->Write();  // "E" ensures error bars are displayed
        Particle2Hist->Write();
        ...
        Particle3ThrustProfile->SetTitle("Thrust Profile Particle3");  // Title inside the plot
        Particle3ThrustProfile->SetXTitle("Charge Multiplicity");
        Particle3ThrustProfile->SetYTitle(" <p_{T}> (GeV)");
        Particle3ThrustProfile->Write();  // "E" ensures error bars are displayed
        Particle3Hist->Write();
        ...
        Particle4ThrustProfile->SetTitle("Thrust Profile Particle4");  // Title inside the plot
        Particle4ThrustProfile->SetXTitle("Charge Multiplicity ");
        Particle4ThrustProfile->SetYTitle(" <p_{T}> (GeV)");
        Particle4ThrustProfile->Write();  // "E" ensures error bars are displayed
        Particle4Hist->Write();
        ...
        Particle5ThrustProfile->SetTitle("Thrust Profile Particle5");  // Title inside the plot
        Particle5ThrustProfile->SetXTitle("Charge Multiplicity");
        Particle5ThrustProfile->SetYTitle(" <p_{T}> (GeV)");
        Particle5ThrustProfile->Write();  // "E" ensures error bars are displayed
        Particle5Hist->Write();
        ...
        Particle6ThrustProfile->SetTitle("Thrust Profile Particle6");  // Title inside the plot
        Particle6ThrustProfile->SetXTitle("Charge Multiplicity");
        Particle6ThrustProfile->SetYTitle(" <p_{T}> (GeV)");
        Particle6ThrustProfile->Write();  // "E" ensures error bars are displayed
        Particle6Hist->Write();
