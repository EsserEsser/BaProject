        ...
        if (t.cmenergy > 90.8 &&  t.cmenergy < 91.6){
            ...
            for (int j = 0; j < t.npart; j++){
                ...
                if (truepdg != 0){
                    ...
                    pPar =pParallelThrust(t.pmomx[j],t.pmomy[j],t.pmomz[j],thrustx,thrusty,thrustz);
                    pPerp =pPerpendicularThrust(t.pmomx[j],t.pmomy[j],t.pmomz[j],thrustx,thrusty,thrustz);
            ...
            for (int j = 0; j < t.nphot; j++){
                ...
                pParPhot =pParallelThrust(t.pphotx[j],t.pphoty[j],t.pphotz[j],thrustx,thrusty,thrustz);
                pPerpPhot =pPerpendicularThrust(t.pphotx[j],t.pphoty[j],t.pphotz[j],thrustx,thrusty,thrustz);
